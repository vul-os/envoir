...
/** @typedef {[string, Record<string, unknown>, string]} JmapMethodCall */
/** @typedef {[string, Record<string, unknown> | undefined, string]} JmapInvocation */
...
/** @param {string} username @param {string} password @returns {string} */
...
/**
 * @typedef {Object} JmapErrorOptions
...
export class JmapError extends Error {
  /** @param {string} message @param {JmapErrorOptions} [opts] */
...
/**
 * @typedef {Object} JmapClientConfig
...
/**
 * @typedef {Object} JmapSession
 * @property {Record<string, unknown>} capabilities
 * @property {Record<string, unknown>} accounts
 * @property {Record<string, string>} primaryAccounts
 * @property {string} username
...
/**
 * @typedef {Object} JmapChangesDelta
 * @property {string} accountId
 * @property {string} oldState
 * @property {string} newState
 * @property {boolean} hasMoreChanges
...
export class JmapClient {
  ...
  /** @param {string} url @param {RequestInit} [init] @returns {Promise<Response>} */
  ...
  /** A cheap reachability + auth probe: resolves true iff the node answers session with 200. @returns {Promise<boolean>} */
  async ping() {
    try {
      await this.discover();
      return true;
   ...
   * @param {JmapMethodCall[]} methodCalls
   * @param {{ using?: string[], createdIds?: Record<string, string> }} [opts]
   * @returns {Promise<JmapResponse>}
   */
  async request(methodCalls, { using, createdIds } = {}) {
    /** @type {{ using: string[], methodCalls: JmapMethodCall[], createdIds?: Record<string, string> }} */
    const envelope = {
    ...
    /** @type {{ methodResponses?: JmapInvocation[], sessionState?: string | null, createdIds?: unknown } | null} */
    let body = null;
   ...
   * @returns {Promise<{ list: Array<{ id: string, role?: string, name?: string }> } | null>}
   */
  async mailboxGet(ids = null) {
    const r = await this.request([
      ['Mailbox/get', { accountId: this.accountId, ids }, 'mb'],
    ]);
    return /** @type {{ list: Array<{ id: string, role?: string, name?: string }> } | null} */ (r.arguments('mb'));
  }
  ...
  async emailQuery(filter = null, extra = {}) {
    ...
    return /** @type {{ ids: string[] } | null} */ (r.arguments('q'));
  }

  /** Email/get (RFC 8621 §4.2). `ids=null` → every email (the node bounds this to the store).
   * @param {string[] | null} [ids]
   * @param {string[] | null} [properties]
   * @returns {Promise<{ list: unknown[], notFound: string[] } | null>}
   */
  async emailGet(ids = null, properties = null) {
    ...
    return /** @type {{ list: unknown[], notFound: string[] } | null} */ (r.arguments('g'));
  }
   ...
   * @returns {Promise<JmapChangesDelta | { cannotCalculateChanges: true }>}
   */
  async emailChanges(sinceState) {
    ...
    if (args && args.type === 'cannotCalculateChanges') return { cannotCalculateChanges: /** @type {const} */ (true) };
    return /** @type {JmapChangesDelta} */ (args);
  }
...
export class JmapResponse {
  /** @param {{ methodResponses?: JmapInvocation[], sessionState?: string | null, createdIds?: unknown }} body */
  constructor(body) {
    /** @type {JmapInvocation[]} */
   ...
   * @param {string} callId @returns {JmapInvocation | null}
   */
  invocation(callId) {
