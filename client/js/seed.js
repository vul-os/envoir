...
export const PEOPLE = [
  ...
  { id: 'priya',  name: 'Priya Iyer',     givenName: 'Priya',  familyName: 'Iyer',       address: 'priya-iyer.eth',      addresses: ['priya@constellation.dev'], avatarUrl: null, hue: 280, trust: 'verified',   org: 'Constellation Labs', title: 'Protocol researcher', phone: null, note: 'Claimed on-chain — her key claims the name and the chain record points back (bidirectional binding, spec §3.12.5b).', tags: ['Work'] },
  { id: 'kofi',   name: 'Kofi Boateng',   givenName: 'Kofi',   familyName: 'Boateng',    address: 'cedar.otter.crane.delta.harbor.lynx.opal.finch', addresses: [], avatarUrl: null, hue: 96, trust: 'verified', org: null, title: 'Key-only identity', phone: null, note: 'No domain, no chain — reachable purely by key-name, the zero-authority floor (spec §3.9.6).', tags: [] },
];
