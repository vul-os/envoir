...
// this repo entirely to the Pier broker repo -- history, not a dependency.
...
/// The legacy SMTP gateway (§7) moved out of this repo entirely (to the Pier broker repo along
