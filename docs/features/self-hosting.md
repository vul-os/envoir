...
[architecture.md](../architecture.md#where-a-third-party-operators-tooling-sits).

Running the node itself is covered in [Getting started](../getting-started.md#run-the-node); this
...
operator's; see [Running the gateway](running-the-gateway.md) for the full build/run/configure
...
[Running the gateway](running-the-gateway.md#addressing-without-registration) and
[Running the gateway](running-the-gateway.md#anti-spam-in-both-directions) for the full mechanics.
...
![Console — domain admin, member directory](../img/console-overview-dark.png)
