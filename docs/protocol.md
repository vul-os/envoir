...
**[vul-os/kotva](https://github.com/vul-os/kotva)** repo as 22 markdown sections plus a compiled
...
sharing one. See [features/self-hosting.md](features/self-hosting.md#the-gateway-address-mapping-in-brief)
