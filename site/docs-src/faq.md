...
decoder is fuzzed, and a 352-case conformance suite exists (188 executing, 0 failures; of the 164
that do not execute, 19 are implementer attestations and 145 are recipes not yet constructible) — but none of that substitutes for the
