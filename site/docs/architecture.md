<!-- GENERATED by scripts/sync-site-docs.mjs from docs/architecture.md — do not hand-edit this file, edit the source instead. -->
...
functional standalone (see [features/self-hosting.md](#self-hosting)) — the operator
...
- Identity — root keypair, device subkeys, recovery policy ([features/identity.md](#identity)).
...
unnecessary. See [protocol.md](#protocol#the-legacy-gateway) and
[features/self-hosting.md](#self-hosting).
...
key, not its address. [`crates/dmtap-p2p`](https://github.com/vul-os/envoir/blob/main/crates/dmtap-p2p) implements this transport for
...
see [roadmap.md](#roadmap) for exactly what's wired into the binary today versus proven at the
crate level.
...
[privacy.md](#privacy) for the full threat model this buys you.
...
pinned as, a key. See [naming.md](#naming) for the full ladder,
[features/identity.md](#identity), and
[protocol.md](#protocol#naming-key-transparency).
...
[`crates/dmtap-seam`](https://github.com/vul-os/envoir/blob/main/crates/dmtap-seam) and its [`CONTRACT.md`](https://github.com/vul-os/envoir/blob/main/crates/dmtap-seam/CONTRACT.md),
with a working, non-commercial reference implementation in
[`crates/dmtap-operator`](https://github.com/vul-os/envoir/blob/main/crates/dmtap-operator). Every hook has a self-host default that is
...
[features/self-hosting.md](#self-hosting#billing-is-tied-to-the-gateway-only) for the
...
| App | Answers | Docs |
|---|---|---|
| [`client/`](https://github.com/vul-os/envoir/blob/main/client) | "I am one sovereign identity" | [features/identity.md](#identity) |
| [`console/`](https://github.com/vul-os/envoir/blob/main/console) | "I administer a domain full of them" | [`console/README.md`](https://github.com/vul-os/envoir/blob/main/console/README.md) |
| [`superadmin/`](https://github.com/vul-os/envoir/blob/main/superadmin) | "I operate the fleet that carries them all" | [`superadmin/README.md`](https://github.com/vul-os/envoir/blob/main/superadmin/README.md) |
| [`status/`](https://github.com/vul-os/envoir/blob/main/status) | "Is my mail working right now?" | [`status/README.md`](https://github.com/vul-os/envoir/blob/main/status/README.md) |
| [`site/`](https://github.com/vul-os/envoir/blob/main/site) | The public pitch | [`site/README.md`](https://github.com/vul-os/envoir/blob/main/site/README.md) |
