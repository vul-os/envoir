<!-- GENERATED by scripts/sync-site-docs.mjs from docs/pwa-and-push.md — do not hand-edit this file, edit the source instead. -->

# PWA, offline, and push — the honest privacy model

The web client ([`client/`](https://github.com/vul-os/envoir/blob/main/client)) is an installable **Progressive Web App**: it works
...
- **Responsive down to ~360px-wide phones**: a master/detail layout that collapses to one pane
  ...
  [`client/README.md`](https://github.com/vul-os/envoir/blob/main/client/README.md#feature-set) for the exact breakpoints.

<p align="center">
  <img src="assets/screens/mail-mobile.png" width="300" alt="Envoir on a phone — installed PWA, responsive mail view">
</p>
...
reference client simulates; see [roadmap.md](#roadmap)).
...
whom. See [privacy.md](#privacy) for the project's broader metadata-privacy model.
...
Also see [`client/README.md`](https://github.com/vul-os/envoir/blob/main/client/README.md#what-is-real-vs-simulated) for exactly which
parts of the push/PWA path are real browser APIs versus this reference client's local-only demo
plumbing, and [security.md](#security) for how this fits the project's broader
