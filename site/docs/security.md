<!-- GENERATED by scripts/sync-site-docs.mjs from docs/security.md — do not hand-edit this file, edit the source instead. -->
...
[`formal/`](https://github.com/vul-os/envoir/blob/main/formal) contains machine-checkable **symbolic (Dolev-Yao) models**, in ProVerif, of
...
Stated honestly, per [`formal/README.md`](https://github.com/vul-os/envoir/blob/main/formal/README.md): these are **symbolic**, not
...
paths, or colluding hops (see [privacy.md](#privacy) for that residual). These models prove the
*ceremonies and primitives as specified* are sound; they don't prove any particular line of Rust
is bug-free. See [`formal/README.md`](https://github.com/vul-os/envoir/blob/main/formal/README.md) for the full, file-by-file property
statements and every one of these limitations spelled out precisely.

## Fuzzing

[`fuzz/`](https://github.com/vul-os/envoir/blob/main/fuzz) runs `cargo-fuzz` (libFuzzer) over every canonical-CBOR **decoder** in
...
See [`fuzz/README.md`](https://github.com/vul-os/envoir/blob/main/fuzz/README.md) for the harness details and history.
...
[`crates/conformance-runner`](https://github.com/vul-os/envoir/blob/main/crates/conformance-runner) is the reference runner: it drives the
...
hardening review. [`crates/downgrade-tests`](https://github.com/vul-os/envoir/blob/main/crates/downgrade-tests) exists solely to hold an
...
[`crates/netsim`](https://github.com/vul-os/envoir/blob/main/crates/netsim) is a deterministic, seeded model of the mixnet's
...
[privacy.md](#privacy#global-passive-adversary-the-chance-floor) for what it found and its
