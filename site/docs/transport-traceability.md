<!-- GENERATED by scripts/sync-site-docs.mjs from docs/features/transport-traceability.md — do not hand-edit this file, edit the source instead. -->
...
![Transport path graph](assets/screens/path-graph.png)
...
[self-hosting.md](#self-hosting#billing-is-tied-to-the-gateway-only). A pure-mesh message can
